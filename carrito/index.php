...
<html lang="en">
	<head>
			...
			<script>
			var usuario = $.parseJSON('<?php echo json_encode($oUsuario); ?>');
			</script>
	...
	<body class="d-flex flex-column h-100">
		...
		<main class="carrito">
			...
			<div class="container-fluid contenedor-pedido">
			</div>
			<hr />
			<div class="container-fluid contenedor-botones text-center">
				<button id="enviar-pedido" class="btn btn-outline-success">Generar Pedido</button>
			</div>
		</main>
